...
tree.column('Book Name', width=100, anchor=CENTER)
tree.column('Book ID', width=50, anchor=CENTER)
tree.column('Author Name', width=100, anchor=CENTER)
tree.column('Book Status', width=50, anchor=CENTER)
tree.column('Issuer Card ID', width=50, anchor=CENTER)

tree.pack(expand=YES, fill=BOTH)

Button(RB_frame, text='View Record', font=btn_font, bg=btn_hlb_bg, command=view_record).pack(fill=X, expand=TRUE, side=LEFT)
Button(RB_frame, text='Change Book Availability', font=btn_font, bg=btn_hlb_bg, command=change_availability).pack(fill=X, expand=TRUE, side=LEFT)
